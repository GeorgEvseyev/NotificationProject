...
protocol UserScreenPresenterOutput: AnyObject {
    ...
    func userScreenInclineSelected()
    func userScreenExpensesSelected()
    func userScreenSettingsSelected()
}
...
extension MainScreenCoordinator: UserScreenPresenterOutput {
    ...
    func userScreenInclineSelected() {
        moveToInclineViewController()
    }

    func userScreenExpensesSelected() {
        moveToExpensesViewController()
    }

    func userScreenSettingsSelected() {
        // пока просто pop или push Settings
